    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 offset-md-1 mb-3 ms-auto">
                ...
                <p> platform berbasis website yang menghadirkan media pembelajaran fisika interaktif dengan kurikulum
                    terkini</p>
            </div>
        </div>
        ...
        <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
            <ul class="list-unstyled d-flex">
                <li class="ms-3">
                    <a class="link-body-emphasis rounded-circle border border-light border-2 d-flex justify-content-center align-items-center text-light"
            ...
            <p>Copyright &copy; 2024 Spinet official. All rights reserved.</p>
        </div>
    </div>
</footer>
