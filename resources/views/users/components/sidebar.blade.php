<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky">
        <h5 class="sidebar-heading p-3 fw-bold">Navigasi</h5>
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link {{ url()->current() == route('user.bookmark') ? 'active-sidebar' : '' }} "
                    href="{{ route('user.bookmark') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ url()->current() == route('user.download') ? 'active-sidebar' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link {{ url()->current() == route('user.notifikasi') ? 'active-sidebar' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link {{ url()->current() == route('user.profile') ? 'active-sidebar' : '' }} "
