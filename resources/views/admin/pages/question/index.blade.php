    ...
    <div class="container-xl">
            ...
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <div class="col-auto">
                            <a class="btn app-btn-primary" href="{{ route('admin.faq.create') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.faq.edit', $item->id) }}" class="btn btn-warning">
                                ...
                                <form id="deleteForm" action="{{ route('admin.faq.destroy', $item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
        ...
        <nav class="app-pagination mt-5">
            <ul class="pagination justify-content-center">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="{{ $question->previousPageUrl() }}" rel="prev">Sebelumnya</a>
                    </li>
                @endif

                {{-- Pagination Elements --}}
                @foreach ($question->links()->elements as $element)
                ...
                @if ($question->hasMorePages())
                    <li class="page-item">
                        <a class="page-link" href="{{ $question->nextPageUrl() }}" rel="next">Berikutnya</a>
                    </li>
                @else
                    <li class="page-item disabled" aria-disabled="true">
