...
@section('content')
    <div class="container-xl">
        ...
        <form action="{{ route('admin.faq.update', $question->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="answer" id="answer" rows="3">{{ $question->answer }}</textarea>
            </div>
