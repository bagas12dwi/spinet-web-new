            ...
            <div class="col-auto">
                <div class="page-utilities">
                    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                        <div class="col-auto">
                            <a class="btn app-btn-primary" href="{{ route('admin.kit.create') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="{{ route('admin.kit.edit', $item->id) }}" class="btn btn-warning">
                                ...
                                <form id="deleteForm" action="{{ route('admin.kit.destroy', $item->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
